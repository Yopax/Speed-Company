    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative z-[-1] flex place-items-center before:absolute before:h-[300px] before:w-full before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 sm:before:w-[480px] sm:after:w-[240px] before:lg:h-[360px]">
        <div className="flex space-x-2 justify-center text-center items-center flex-col">
          <p className="text-5xl max-[425px]:text-2xl max-[425px]:w-full max-[425px]:pt-2 w-[75%] font-extrabold text-black dark:text-white">
          Construimos el futuro, fusionando tecnología y creatividad
          </p>
          <p className="py-4">En Speed, fusionamos la solidez de la construcción con la innovación tecnológica. </p>
        </div>
      </div>
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          Descubre nuestros proyectos integrando tecnología avanzada y construcción eficiente.
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
          Conoce nuestra visión y cómo fusionamos ingeniería y desarrollo tecnológico.
          </p>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
          Aprende con nosotros a implementar soluciones tecnológicas en el sector de la construcción.
          </p>
        </a>
        ...
        >
          ...
          Hablemos sobre cómo podemos construir el futuro juntos, con innovación y precisión.
          </p>
        </a>
      </div>
    </main>
